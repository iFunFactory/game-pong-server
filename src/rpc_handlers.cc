...
void OnMatchResultRpc(
  const Rpc::PeerId &sender,
  const Rpc::Xid &xid,
...
void MatchmakeRpcResponseCallback(
  const Rpc::PeerId &sender,
  const Rpc::Xid &xid,
...
void OnCancelMatchRpcReplyCallback(
  const Rpc::PeerId &sender,
  const Rpc::Xid &xid,
  const Ptr<const FunRpcMessage> &res) {
...
void OnCancelMatchByTcpDetached(
  const Rpc::PeerId &sender,
  const Rpc::Xid &xid,
  const Ptr<const FunRpcMessage> &request) {
