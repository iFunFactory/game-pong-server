...
LockType User::GetLockType() const {
  if (IsNull()) {
    return kNoneLock;
  }

  return object()->lock_type();
}
...
void RegisterUserModel() {
  ...
  attrs.push_back(Ptr<const AttributeModel>(
      new AttributeModel(
          "Id", fun::AttributeModel::kString, 64, true, false, false, false, false, false)));
  attrs.push_back(Ptr<const AttributeModel>(
      new AttributeModel(
          "WinCount", fun::AttributeModel::kInteger64, 0, false, false, false, false, false, false)));
  attrs.push_back(Ptr<const AttributeModel>(
      new AttributeModel(
          "LoseCount", fun::AttributeModel::kInteger64, 0, false, false, false, false, false, false)));
