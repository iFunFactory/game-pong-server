...
void MaintenanceMessage::SharedCtor() {
  _cached_size_ = 0;
  date_start_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
  date_end_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
...
void MaintenanceMessage::SharedDtor() {
  if (date_start_ != &::google::protobuf::internal::kEmptyString) {
    delete date_start_;
  }
  if (date_end_ != &::google::protobuf::internal::kEmptyString) {
    delete date_end_;
  }
